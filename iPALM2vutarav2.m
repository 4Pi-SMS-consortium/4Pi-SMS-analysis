...
function [flag]=iPALM2vutarav2(resultfolder,filename,colornum,xcell,ycell,zcell,tcell,Icell,crlbcell,LLRcell,conf1,conf2,conf3)
...
% c=['asda,asdasd'];
% time = clock;
% stringTime = ['_' num2str(time(1)) '_' num2str(time(2)) '_' num2str(time(3)) '_' num2str(time(4)) '_' num2str(time(5))];
% fid = fopen([rfolder 'particles' stringTime '.csv'],'wt');
...
%     dlmwrite([rfolder 'particles' stringTime '.csv'],Mtot,'-append')
